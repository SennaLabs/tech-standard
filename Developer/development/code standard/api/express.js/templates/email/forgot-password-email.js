module.exports = (resetPasswordToken, name, feURL) => {
  return `
    <!DOCTYPE html>
        <html lang="en">
            <head>
                ...
                <div class="card-container">
                    ...
                    <div class="content">
                        ...
                        <div class="body-1" style="margin-top: 24px;">
                            Please click accept reset your password and join the REPCONEX AIMS-DMS application
                        </div>
                        <p class="body-1" style="margin-top: 24px;">Best regards,</p>
                        <p class="body-1">Support Team</p>
                        <div class="link-button">
                            <a href="${feURL}/auth/setup-password?resetPasswordToken=${resetPasswordToken}"
                                class="setup-account-btn" target="_blank">Reset password</a>
                        </div>
                    </div>
                    <div class="footer">
